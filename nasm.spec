...
Source0  : http://www.nasm.us/pub/nasm/releasebuilds/2.15.03/nasm-2.15.03.tar.xz
...
%prep
%setup -q -n nasm-2.15.03
cd %{_builddir}/nasm-2.15.03
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595263641
...
cp %{_builddir}/nasm-2.15.03/LICENSE %{buildroot}/usr/share/package-licenses/nasm/4ff4760dfc54975ddb40a3455633574849bc5611
%make_install
